...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.bandwidthCombo, 1, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.bbGainLabel, 2, 0, 1, 1)
        self.bbGainSpin = QtGui.QSpinBox(self.centralwidget)
        self.bbGainSpin.setMinimum(0)
        self.bbGainSpin.setMaximum(100)
        self.bbGainSpin.setProperty("value", 0)
        self.bbGainSpin.setObjectName("bbGainSpin")
        self.gridLayout_2.addWidget(self.bbGainSpin, 2, 1, 1, 1)
        ...
        self.sqlSlider.setMinimum(-100)
        self.sqlSlider.setMaximum(0)
        self.sqlSlider.setSingleStep(1)
        self.sqlSlider.setProperty("value", -100)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_1.setText(QtGui.QApplication.translate("MainWindow", "dB", None, QtGui.QApplication.UnicodeUTF8))
